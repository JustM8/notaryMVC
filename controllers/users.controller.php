        ...
        if ($_POST['login'] !='') {
            ...
            if (strlen($_POST['login']) == 12) {
                if (strlen($password) < 3) {
                    Session::setFlash('Слишком короткий пароль - введите больше 3х символов');
                } else {
                    $strong = 0;
                    ...
                    if ($strong == 1) {
                        Session::setFlash('Очень слабый - добавьте букв');
                    }
                    if ($strong == 2) {
                        Session::setFlash('Слабый - добавьте букв разной велечины');
                    }
                    if ($strong == 3) {
                        Session::setFlash('Простой - добавьте спец символ');
                    }
                    if ($strong == 4) {
                        Session::setFlash('Надежный');
                    }
                }
                if ($strong == 4) {
                ...
                Session::setFlash('Номер введен не полностью');
            }
        }
    }
