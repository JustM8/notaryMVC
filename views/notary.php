...
<script>
    $('input[name="login"]').mask('380000000000');
    $('input[name="fName"]').mask('S', {'translation': {'S':  {pattern: /[a-zA-Zа-яА-Я]/, recursive: true}}});
    $('input[name="sName"]').mask('S', {'translation': {'S':  {pattern: /[a-zA-Zа-яА-Я]/, recursive: true}}});
    $('input[name="email"]').mask("A", {
        translation: {
            "A": { pattern: /[\a-zA-Zа-яА-Я0-9@\-.+]/, recursive: true }
        }
    });
</script>
